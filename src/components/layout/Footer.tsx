...
const DEFAULT_FOOTER = {
  ...
  newsletterDisclaimer:
    'Get weekly product updates and industry insights. Unsubscribe anytime with one click.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Support',
  section4Title: 'Legal',
  copyrightText: '© 2024 ExampleSaaS. All rights reserved.',
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        { name: 'About ExampleSaaS', href: '/about', editableId: 'link-footer-about' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Migration Guide', href: '/migration', editableId: 'link-footer-migration' },
      ],
    },
    {
