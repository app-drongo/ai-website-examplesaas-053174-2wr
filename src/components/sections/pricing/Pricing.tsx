...
const DEFAULT_PRICING = {
  ...
  mainDescription:
    "Join 10,000+ businesses automating their workflows with ExampleSaaS. Choose the perfect plan for your team's growth.",
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 20%',
  plan1Name: 'Starter',
  plan1Description: 'Perfect for small teams getting started with automation',
  plan1Price: 'Free',
  plan1CTA: 'Start Free Trial',
  plan1CTAHref: '/pricing',
  plan2Name: 'Professional',
  plan2Description: 'Best for growing businesses scaling their operations',
  plan2Price: '$49',
  plan2Period: '/month',
  plan2Badge: 'Most Popular',
  plan2CTA: 'Start 14-Day Trial',
  plan2CTAHref: '/pricing',
  plan2Trial: '14-day free trial • No credit card required',
  plan3Name: 'Enterprise',
  plan3Description: 'For large organizations with advanced security needs',
  plan3Price: 'Custom',
  plan3Badge: 'Contact Sales',
  plan3CTA: 'Schedule Demo',
  plan3CTAHref: '/pricing',
  bottomTitle: 'Need a custom solution?',
  bottomDescription:
    "We offer tailored enterprise solutions with dedicated support, custom integrations, and advanced security features. Let's discuss your specific requirements.",
  bottomCTA: 'Contact Sales Team',
  bottomCTAHref: '/pricing',
} as const;
            ...
            >
              ...
              <CardHeader className={cn('relative text-center pb-8', plan.popular && 'pt-10')}>
                ...
                {billingCycle === 'annual' && plan.name === config.plan2Name && (
                  <p className="text-sm text-primary mt-2">Save $120 per year</p>
                )}
              </CardHeader>
