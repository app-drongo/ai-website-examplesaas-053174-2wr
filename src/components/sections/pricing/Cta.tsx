...
const DEFAULT_CTA = {
  ...
  mainTitle: 'Ready to Scale Your',
  mainTitleHighlight: 'Business Operations?',
  description:
    'Join 10,000+ growing businesses using ExampleSaaS to automate workflows and boost productivity. Start your 14-day free trial and experience 80% faster task completion.',
  primaryCTA: 'Start Free Trial',
  primaryCTAHref: '/pricing',
  secondaryCTA: 'View All Plans',
  secondaryCTAHref: '/pricing',
  trustText: 'Trusted by 10K+ businesses worldwide with 99.9% uptime',
  stat1Value: '10K+',
  ...
  feature2Description: 'SOC 2 compliant with bank-grade encryption',
  feature3Title: 'Quick Setup',
  feature3Description: 'Get up and running in under 5 minutes',
} as const;
