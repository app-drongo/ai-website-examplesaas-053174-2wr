...
const DEFAULT_CTA = {
  ...
  description:
    'Join over 10,000 growing businesses who trust ExampleSaaS to streamline their workflows, boost productivity, and drive results. No setup fees, no long-term contracts.',
  primaryCTA: 'Start Free Trial',
  primaryCTAHref: '/pricing',
  secondaryCTA: 'View Pricing',
  secondaryCTAHref: '/pricing',
  trustText: 'Trusted by fast-growing companies worldwide',
  stat1Value: '10K+',
  ...
  feature2Description: 'SOC 2 compliant with bank-level encryption',
  feature3Title: '5-Minute Setup',
  feature3Description: 'Import your data and go live in minutes',
} as const;
