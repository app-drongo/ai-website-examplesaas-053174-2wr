...
const DEFAULT_HERO = {
  ...
  description:
    'Transform your workflow with our comprehensive business automation platform. Reduce manual tasks by 80% and boost productivity across your entire organization.',
  features: [
  ...
  imageAlt: 'ExampleSaaS dashboard interface',
